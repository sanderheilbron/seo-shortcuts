...
chrome.omnibox.onInputChanged.addListener(function(text, suggest) {
    ...
    const commands = [
        ...
        },
        {
            content: 'ampb',
            description:
                '<dim>command </dim><match>ampb</match> - Check current URL in AMPBench',
        },
        {
            content: 'ampv',
            description:
        ...
        },
        {
            content: 'ose',
            description:
                '<dim>command </dim><match>ose</match> - Check current URL in Moz Open Site Explorer',
        },
        {
            content: 'pa',
            description:
        ...
        },
        {
            content: 'sdtt',
            description:
                '<dim>command </dim><match>sdtt</match> - Check current URL in Google Structured Data Testing Tool',
        },
        {
            content: 'sh',
            description:
        ...
        },
        {
            content: 'si',
            description:
                '<dim>command </dim><match>si</match> - Shows the calculated Speed Index for the current URL in the console',
        },
        {
            content: 'sm',
            description:
...
chrome.runtime.onInstalled.addListener(function(details) {
    ...
    if (details.reason == 'install') {
        ...
        // If Chrome version supports it uninstall extension for updated (1.2.0) users and open uninstall URL
        if (chrome.runtime.setUninstallURL) {
            chrome.runtime.setUninstallURL(uninstallURL);
        }
    }
