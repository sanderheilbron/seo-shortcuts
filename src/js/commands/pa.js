        ...
        */
        ...
        pieChartComponent.init = function() {
            ...
            var setupChart = function(title, chartData, countTexts, columns, id) {
                ...
                chartHolder.appendChild(dom.newTag("p", {
            ...
            setupChart("Requests by Domain", requestsByDomainData, ["Domains Total: " + data.requestsByDomain.length], [{
                name: "Requests",
                field: "count"
            }, {
        ...
        */
        ...
        summaryTilesComponent.init = function() {
            ...
            var createAppendixDefValue = function createAppendixDefValue(a, definition, value) {
                a.appendChild(dom.newTag("dt", {
                    childElement: definition
                }));
                a.appendChild(dom.newTag("dd", {
                    text: value
                }));
            };
            ...
            [createTile("Requests", data.requestsOnly.length || "0"), createTile("Domains", data.requestsByDomain.length || "0"), createTile(dom.combineNodes("Subdomains of ", dom.newTag("abbr", {
                title: "Top Level Domain",
                text: "TLD"
            })), data.hostSubdomains || "0"), createTile(dom.combineNodes("Requests to ", dom.newTag("span", {
                title: location.host,
                text: "Host"
            })), data.hostRequests || "0"), createTile(dom.combineNodes(dom.newTag("abbr", {
                title: "Top Level Domain",
                text: "TLD"
            }), " & Subdomain Requests"), data.currAndSubdomainRequests || "0"), createTile("Total", data.perfTiming.loadEventEnd - data.perfTiming.navigationStart + "ms", 40), createTile("Time to First Byte", data.perfTiming.responseStart - data.perfTiming.navigationStart + "ms", 40), createTile(dom.newTag("span", {
                title: "domLoading to domContentLoadedEventStart",
                text: "DOM Content Loading"
            }), data.perfTiming.domContentLoadedEventStart - data.perfTiming.domLoading + "ms", 40), createTile(dom.newTag("span", {
                title: "domLoading to loadEventStart",
                text: "DOM Processing"
            }), data.perfTiming.domComplete - data.perfTiming.domLoading + "ms", 40)].forEach(function(tile) {
                tilesHolder.appendChild(tile);
            });

            if (data.allResourcesCalc.length > 0) {
                tilesHolder.appendChild(createTile(dom.newTag("span", {
            ...
            createAppendixDefValue(appendix, dom.newTag("abbr", {
                title: "Top Level Domain",
                text: "TLD"
    ...
    7: [function(require, module, exports) {
        ...
        */
        ...
        tableComponent.init = function() {
            ...
            sectionHolder.appendChild(dom.newTag("h1", {
    ...
    13: [function(require, module, exports) {
        ...
        pieChartHelpers.createChartTable = function(title, data, columns) {
            ...
            return dom.tableFactory("", function(thead) {
                thead.appendChild(dom.newTag("th", {
                    text: title,
                    "class": "text-left"
                }));
