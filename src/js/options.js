...
function saveOptions() {
    ...
    var interfaceLanguage = document.getElementById('interfaceLanguage').value || '';
...
function loadOptions() {
    chrome.storage.sync.get(["countryVersion", "interfaceLanguage", "autoRun"], function(settings) {
